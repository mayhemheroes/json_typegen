...
export type WorkerMessageType
    ...
    | { type: WorkerMessage.CODEGEN, input: string, typename: string, options: object }
    | { type: WorkerMessage.CODEGEN_COMPLETE, result: string, typename: string, options: object }
